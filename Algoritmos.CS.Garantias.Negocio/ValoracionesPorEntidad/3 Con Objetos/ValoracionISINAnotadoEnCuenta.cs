...
namespace ConObjetos
{
    public class ValoracionISINAnotadoEnCuenta
    {
        ...
        public ValoracionISINAnotadoEnCuenta(List<ISIN> listaDeISINEnUDESAnotadosEnCuenta, DateTime fechaActual, decimal tipoDeCambioDeUDESDeAyer, decimal tipoDeCambioDeUDESDeHoy)
        {
